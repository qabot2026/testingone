...
window.COMPANY_CHAT_UI_CONFIG = {
  ...
  common: {
    ...
    dialogflow: {
      ...
      agentId: "e3fbf52c-3350-48b2-b2d1-4cd9f1f21726"
    },
    ...
    /** Optional legacy icon row — connect/rejoin notices use {@link botPersona} (Quality) instead. */
    agentPersona: {
      mode: "icon",
      label: "Support Agent",
      imageUrl: ""
    ...
    personaDisplay: {
      ...
      /** Whole user persona row (avatar + You + time) — nudge down (px). */
      userPersonaRowNudgeDownPx: 7,
