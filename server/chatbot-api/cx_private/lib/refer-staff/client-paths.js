...
const CLIENT_PUBLIC = path.join(PROJECT_ROOT, 'cx_public', 'client-based');
const CLIENT_PRIVATE = path.join(PROJECT_ROOT, 'cx_private', 'client-based');

function dataDir() {
  return path.join(PROJECT_ROOT, 'cx_private', 'data');
}
