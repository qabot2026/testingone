(function () {
    ...
    function applyBusinessHours_(bh) {
        ...
        if (window.ESTimezoneOptions && $("bhTimezone")) {
            ESTimezoneOptions.fillSelect($("bhTimezone"), base.timezone || ESTimezoneOptions.DEFAULT);
        } else {
    ...
    if (window.ESTimezoneOptions && $("bhTimezone")) {
        ESTimezoneOptions.fillSelect($("bhTimezone"), ESTimezoneOptions.DEFAULT);
    }
